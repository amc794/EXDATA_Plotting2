...
## Download data
setwd("C:/Users/Abimbola/Documents/DataScience/EXPLORATORY")
url <- "https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2FNEI_data.zip" 
destzip<- "~/DataScience/EXPLORATORY/exdata_data_NEI_data.zip" 
download.file(url, destzip) 
unzip(destzip, exdir = "~/DataScience/EXPLORATORY") 
dir()
...
## Question 6: Compare emissions from motor vehicle sources in Baltimore City with LA County,CA
...
## Compare emissions from motor vehicle sourcesin LA County and Baltimore
